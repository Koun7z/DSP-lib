                                  ...
                                  const float dt)
{
    ...
    DSP_QT_Multiply_f32(&delta_q_gyro, &omega_l, &data->AttitudeEstimate);
    ...
    DSP_QT_Multiply_f32(&data->AttitudeEstimate, &q_gyro, &delta_q_acc);
    ...
    */
    ...
    DSP_QT_Conjugate_f32(&q_acc_LG, &data->AttitudeEstimate);
    ...
    DSP_QT_Multiply_f32(&data->AttitudeEstimate, &data->AttitudeEstimate, &delta_q_mag);
    DSP_QT_Normalize_f32(&data->AttitudeEstimate, &data->AttitudeEstimate);
}
